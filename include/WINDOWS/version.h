...
#define OPENCBM_VERSION_SUBMINOR    2
#define OPENCBM_VERSION_PATCHLEVEL  0
#define OPENCBM_VERSION_DEVEL       0
...
#define OPENCBM_BUILD_VERSION_STRING_CVS "$Id: version.h,v 1.98.2.2 2007/11/18 14:46:11 strik Exp $"
